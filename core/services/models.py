...
class DailySalesReport(models.Model):
    ...
    generated_by = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name='sales_reports_generated'
    )
    ...
    def __str__(self):
        return f"Sales Report - {self.date} by {self.generated_by}"
...
class SalesReportNote(models.Model):
    ...
    added_by = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name='sales_notes_added'
    )
    ...
    def __str__(self):
        return f"Note on {self.report.date} by {self.added_by}"
...
class DailyExpense(models.Model):
    ...
    recorded_by = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name='expenses_recorded'
    )
...
class MaterialUsage(models.Model):
    ...
    def __str__(self):
        return f"{self.taken_by.get_full_name() or self.taken_by.username} took {self.quantity_taken} {self.material.unit} of {self.material.name}"
